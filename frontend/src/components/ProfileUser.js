...
import fena from '../assets/img/fenah.jpg'
      ...
      <main id="main" className="main">
                ...
                <div className="row">
                    ...
                    <div className="card">
                        ...
                        <img src={fena} alt="Profile" className="rounded-circle miEstiloFoto"/>
                        <h2>Fenah Keiponye</h2>
                    ...
                    <div className="card">
                        ...
                        <div className="tab-content pt-2">
                            ...
                            <p className="small fst-italic">hello world! My name is Fenah Keiponye, an employee at University of Botswana.</p>

                            <h5 className="card-title">Profile Details</h5>

                            <div className="row">
                                <div className="col-lg-3 col-md-4 label ">Full Name</div>
                                <div className="col-lg-9 col-md-8">Fenah Keiponye</div>
                            </div>

                            <div className="row">
                                <div className="col-lg-3 col-md-4 label">Company</div>
                                <div className="col-lg-9 col-md-8">University of Botswana</div>
                            </div>

                            <div className="row">
                                <div className="col-lg-3 col-md-4 label">Job</div>
                                <div className="col-lg-9 col-md-8">UI/UX Designer</div>
                            </div>

                            <div className="row">
                                <div className="col-lg-3 col-md-4 label">Country</div>
                                <div className="col-lg-9 col-md-8">Botswana</div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-9 col-md-8">(267) 77767545</div>
                            </div>

                            <div className="row">
                                <div className="col-lg-3 col-md-4 label">Email</div>
                                <div className="col-lg-9 col-md-8">lebogangkeiponye@gmail.com</div>
                            </div>
                            ...
                            <form>
                                ...
                                <div className="col-md-8 col-lg-9">
                                    <textarea name="about"  className="form-control" id="about" style={{"height": 100}}>  </textarea>
                                </div>
                                </div>
